...
#define Google_Map_Key @"AIzaSyB8gXRjZ9aj2gqAvbAVWBQC2gkpytNFirA"//@"AIzaSyDwTcU4CgAYzwRluvTXWJXztlCEZcCu5L0"//@"AIzaSyB8gXRjZ9aj2gqAvbAVWBQC2gkpytNFirA"//
#define GOOGLE_KEY_NEW @"AIzaSyCLDSZl4y2CfTWwPzJ933jS2X5jOpDFkEI"

//#define API_URL @"http://web.spinati.com/public/user/"
#define API_URL @"http://vps268776.ovh.net/rushiz2/public/user/" //http://vps268776.ovh.net/rushiz/public/ ///http://mctitsolutions.com/rushiz_laravel/public/user/
//#define SERVICE_URL @"http://web.spinati.com/public/"
#define SERVICE_URL @"http://vps268776.ovh.net/rushiz2/public/"

#define Address_URL @"https://maps.googleapis.com/maps/api/geocode/json?"
#define PRIVACY_URL @"http://web.spinati.com/public/terms.html"
...
extern NSString *const FILE_TRANSPORT;
extern NSString *const FILE_SERVICE;
extern NSString *const FILE_ARTICLE;
extern NSString *const FILE_DIMENSION;
extern NSString *const FILE_ORDER;
extern NSString *const FILE_VIEW_CART;
extern NSString *const FILE_CART_DELETE;
extern NSString *const FILE_TRANSPORT_IOS;
extern NSString *const FILE_PAYMENT_ORDER;
extern NSString *const FILE_PROFILE_VIEW;
extern NSString *const FILE_PROFILE_UPDATE;
extern NSString *const FILE_PROMO_CODE;
extern NSString *const FILE_OWNER_WAITORDER;
extern NSString *const FILE_OWNER_ACCEPT_WAIT_ORDER;
extern NSString *const FILE_OWNER_COMPLETE_ORDER;
extern NSString *const FILE_OWNER_PACK_ORDER_DETAILS;
extern NSString *const FILE_SAVE_ORDER_INFO;
extern NSString *const FILE_SAVE_CARD_INFO;
extern NSString *const FILE_DISPLAY_CARD_INFO;
extern NSString *const FILE_DELETE_CARD_INFO;
extern NSString *const FILE_GET_ORDER_BILL;
extern NSString *const FILE_GET_PROVIDER_CURRENT_LOCATION;
extern NSString *const FILE_RATING;
#pragma mark -
...
extern NSString *const PREF_IMAGES;
extern NSString *const PREF_EURO;
extern NSString *const PREF_DISABLE;
extern NSString *const PREF_TRANSPORT;
extern NSString *const PREF_TOTAL_MINUT_KM;
extern NSString *const PREF_TRANST_NAME;
extern NSString *const PREF_DELIVERYBOY_IMAGE;
extern NSString *const PREF_DELIVERYBOY_NAME;
#pragma mark -
